<?php
/* Smarty version 3.1.32, created on 2018-05-29 19:34:48
  from '/root/project/xcb/wap/view/mall/cart_detail.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b0d3ad8cd6821_58349442',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '20cb7e82e46287d703b7a5c3ddd213d3ea518f5d' => 
    array (
      0 => '/root/project/xcb/wap/view/mall/cart_detail.html',
      1 => 1527593684,
      2 => 'file',
    ),
  ),
...
function content_5b0d3ad8cd6821_58349442 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
					...
					<li class="mui-table-view-cell mui-media">
						<a href="javascript:;">
							<div class="mui-media-object mui-pull-left">
								<img id="<?php echo $_smarty_tpl->tpl_vars['item1']->value['cart_id'];?>
" class="sps-shopping-car-checkbox" src="/public/web/images/no_choose.png">
							</div>
							<img id="cartImg" class="mui-media-object mui-pull-left" src="<?php echo $_smarty_tpl->tpl_vars['item1']->value['img'];?>
">
							<div class="mui-media-body">
								<div class="mui-ellipsis">
									<?php echo $_smarty_tpl->tpl_vars['item1']->value['deal_name'];?>

								</div>
								<p class="sps-shopping-car-price">
									<span class="sps-per-price"><?php echo $_smarty_tpl->tpl_vars['item1']->value['current_price'];?>
</span>
								</p>
								<div class="plus-or-minus">
									<table>
										<tr>
											...
											<td id="sps-pom-mid" class="sps-pom-mid"><?php echo $_smarty_tpl->tpl_vars['item1']->value['num'];?>
 </td>
			...
			<div class="sps-pay-order-detail">
				<table>
					<!--<tr id="oneBuy" class="hide">
						<td class="sps-pay-order-product"><img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['img'];?>
" /> </td>
						<td class="sps-pay-order-words">
							<p><?php echo $_smarty_tpl->tpl_vars['data']->value['deal_name'];?>
</p>
							<p>
								<span id="merPrice" class="sps-price"><?php echo $_smarty_tpl->tpl_vars['data']->value['current_price'];?>
</span>
...
" /> </td>
				...
				<table class="sps-pay-order-consignee" onclick="window.location.href='index.php?ctl=setting&amp;act=address_gl&addr=1'">
					<tr>
						<td>
							<p>收货人：<span id="receivePayer"><?php echo $_smarty_tpl->tpl_vars['address']->value[0]['user_name'];?>
</span></p>
							<p>联系电话：<span id="contact"><?php echo $_smarty_tpl->tpl_vars['address']->value[0]['user_phone'];?>
</span></p>
							<p>收货地址：<span id="receiveAddr"><?php echo $_smarty_tpl->tpl_vars['address']->value[0]['address'];
echo $_smarty_tpl->tpl_vars['address']->value[0]['address1'];?>
</span></p>
						</td>
					...
					<table>
						<tr>
							...
							<td style="width: 75%;">
								...
								<span style="font-size: 12px;color: #C0C0C0;">当前积分：<?php echo $_smarty_tpl->tpl_vars['user_info']->value['consume_credits'];?>
</span>
							</td>
...
>
		...
		$('.sps-pwd-confirm').click(function() {
			...
			var id = '<?php echo $_smarty_tpl->tpl_vars['user_info']->value['id'];?>
';
			var cartId = '';
			...
			var addressId = '<?php echo $_smarty_tpl->tpl_vars['address']->value[0]['address_id'];?>
';
...
';
		...
		var nowP = '<?php echo $_smarty_tpl->tpl_vars['price']->value;?>
';
